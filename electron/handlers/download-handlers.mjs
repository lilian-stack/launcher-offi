...
} from '../services/state.mjs'
import { detectProvider } from '../utils/download-helpers.mjs'
import { getHiddenWindow } from '../services/window-manager.mjs'

// Import lazy des providers
let downloadProviders = null
async function getDownloadProviders() {
  if (!downloadProviders) {
    downloadProviders = await import('../services/download-providers/index.mjs')
  }
